...
public class Mantenimiento_Empleados extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        List<Empleados> usuarios = empleadoDAO.select();
    ...
    private void BtnBusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBusActionPerformed
        Empleados usuarioBuscar = new Empleados();
        EmpleadosDAO usuarioDAO = new EmpleadosDAO();
    ...
    private void BtnElimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnElimActionPerformed
        Empleados usuarioEliminar = new Empleados();
        EmpleadosDAO usuarioDAO = new EmpleadosDAO();
    ...
    private void BtnModActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnModActionPerformed
        Empleados usuarioMod = new Empleados();
        EmpleadosDAO usuarioDAO = new EmpleadosDAO();
        String ID = txtID.getText();
        int IntID = Integer.parseInt(ID);
        ...
        usuarioMod.setPassword_usuario(pass);
    ...
    private void BtnIngActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnIngActionPerformed
        ...
        Empleados usuarioInsertar = new Empleados();
        EmpleadosDAO usuarioDAO = new EmpleadosDAO();
        ...
        if (txtID.getText().length() != 0 && txtNom.getText().length() != 0
                ...
                || RBCC0.isSelected() && RBEU1.isSelected() || RBEU0.isSelected()) {
            {
                ...
                usuarioInsertar.setPassword_usuario(pass);
    ...
    private void BtnAyudaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAyudaActionPerformed
        try {
            if ((new File("src\\Ayudas\\AyudaMantenimientoEmpleados.chm")).exists()) {
                Process p = Runtime
                        .getRuntime()
                        .exec("rundll32 url.dll,FileProtocolHandler src\\Ayudas\\AyudaMantenimientoEmpleados.chm");
                p.waitFor();
            } else {
